...
public class DragTextButton extends TextButton {
	public DragTextButton(Director am, 
			Bitmap bmpNormal, Bitmap bmpPressed, String title, int id, float x, float y) {
		super(am, bmpNormal, bmpPressed, title, id, x, y, null);
